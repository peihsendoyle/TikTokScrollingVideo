...
extension ActionNode {
    private func configureTextFieldButtonNode() {
        ...
        textFieldButtonNode.addTarget(self, action: #selector(touchTextField), forControlEvents: .touchUpInside)
    }
    ...
    private func configureLikeButtonNode() {
        ...
        likeButtonNode.addTarget(self, action: #selector(touchLike), forControlEvents: .touchUpInside)
    }
    ...
    private func configureStarButtonNode() {
        ...
        starButtonNode.addTarget(self, action: #selector(touchStar), forControlEvents: .touchUpInside)
    }
    ...
    private func configureCommentButtonNode() {
        ...
        commentButtonNode.addTarget(self, action: #selector(touchComment), forControlEvents: .touchUpInside)
    }
}
...
extension ActionNode {
    ...
    @objc private func touchLike() {
        onTapLikeButton?()
    }
    
    @objc private func touchStar() {
        onTapStarButton?()
    }
    
    @objc private func touchComment() {
        onTapCommentButton?()
    }
}
